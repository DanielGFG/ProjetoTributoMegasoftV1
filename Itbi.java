...
//-----------------------------------------------------------------------------------------------------------------------//
// SubClasse Itbi recebendo atributos e métodos da SuperClasse Tributo;
public class Itbi extends Tributo {
    //-------------------------------------------------------------------------------------------------------------------//
    // Construtor Itbi que recebe parâmetros que irão settar os atributos;
    public Itbi(String pag, String cn, float val, String dataPag, String dataVenc, String porc) {
    ...
    public void CalculaJuros() {
        ...
        double valorJurosDia = this.getValor() * (0.25 / 100);
